...
5. Если фраза ложится, но непонятно на что именно, верни clarify с коротким
   ...
   Уточняют ДЕЙСТВИЕ, а не адресата. Если человек назван словами («у Берна»,
   «спрашиваю Нильса») ИЛИ разговор уже идёт (ниже сказано «разговор идёт с …»),
   ты ЗНАЕШЬ, к кому обращён вопрос — верни question или ask_about с этим
   человеком, а target можешь оставить пустым, его подставят. НИКОГДА не спрашивай
   «к кому вы обращаетесь», когда собеседник назван или разговор идёт.
...
Разговор идёт с e_bern; детали места: p_barrels — Штабель бочек
Игрок: «а что это за штабель бочек?»
Ответ: {"outcome":"intent","verb":"ask_about","target":"e_bern"}
Вопрос обращён к собеседнику — о том, что вокруг. Это ask_about к нему, а не
clarify: к кому обращён вопрос, известно.

Сцена: e_bern — Берн, стражник; детали места: p_barrels — Штабель бочек
Игрок: «спрашиваю у Берна, что это за бочки»
Ответ: {"outcome":"intent","verb":"ask_about","target":"e_bern"}
Адресат назван прямо — уточнять «к кому» незачем.

Разговор идёт с e_bern
Игрок: «достаю из кармана»
Ответ: {"outcome":"clarify","clarify":"Что вы достаёте?"}
Уточняют само действие (что достаёте), не адресата: собеседник известен.
