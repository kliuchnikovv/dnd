...
// SceneHint — всё, что парсер знает о мире, и его read scope целиком
// (llm.Capabilities[llm.RoleIntentParser].Reads): сцена, party_knowledge,
// носимое. Строится ИСКЛЮЧИТЕЛЬНО из того,
