...
память разговора) — говори ИЗ НЕЁ: она про человека, не про дело.
  ...
  - слова персонажа; допустим один короткий диегетический штрих телом (взгляд,
    жест, куда смотрит) — но не пересказ его внутреннего мира и не «он
    усмехнулся» третьим лицом. Одна короткая ремарка максимум, дальше речь;
